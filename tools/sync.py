...
DEFAULT_CONFIG = """solutions = [{"managed": True, "name": "src", "url": "https://github.com/jtg-gg/chromium.src.git@dev42-m78", "custom_deps": {}, "deps_file": "content/nw/DEPS", "safesync_url": "", "custom_vars": {}}]"""
