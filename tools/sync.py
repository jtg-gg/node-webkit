...
DEFAULT_CONFIG = """solutions = [{"managed": True, "name": "src", "url": "https://github.com/jtg-gg/chromium.src.git@dev33-m69", "custom_deps": {}, "deps_file": "content/nw/DEPS", "safesync_url": "", "custom_vars": {}}]"""
...
cmd = ['gclient', 'sync', '--with_branch_heads', '-f', '-v', '--spec', (DEFAULT_CONFIG)]
